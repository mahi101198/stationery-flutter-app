 ...
 */
async function handleRazorpayPayment(orderId, userId, paymentId, amount, currency) {
 ...
 */
async function handleCODPayment(orderId, userId, paymentId, amount, currency) {
 ...
 */
async function handleWalletPayment(orderId, userId, paymentId, amount, currency, walletAmount) {
 ...
 */
async function handlePartialWalletPayment(orderId, userId, paymentId, amount, currency, walletAmount) {
...
async function handleOrderPaid(payload) {
    ...
    try {
        ...
        if (existingOrderSnap.exists && ((_c = existingOrderSnap.data()) === null || _c === void 0 ? void 0 : _c.status) === 'confirmed') {
 ...
 */
async function handleCODRefund(orderId, paymentId, refundAmount, cancelReason) {
 ...
 */
async function handleWalletRefund(orderId, paymentId, refundAmount, userId, cancelReason) {
 ...
 */
async function handleRazorpayRefund(orderId, paymentId, refundAmount, cancelReason) {
    ...
    return {
        ...
        breakdown: {
            ...
            razorpayRefund: {
                ...
                refundId: (razorpayRefundResult === null || razorpayRefundResult === void 0 ? void 0 : razorpayRefundResult.id) || null
            }
        },
