 ...
 */
async function sendDeliveryConfirmationNotification(orderId: string, orderData: any) {
  try {
 ...
 */
async function storeDeliveryConfirmationNotification(userId: string, orderId: string, orderNumber: string) {
  try {
